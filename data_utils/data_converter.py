...
"""Taken  from https://github.com/NVlabs/edm/blob/main/dataset_tool.py"""
import functools
import gzip
import io
import json
...
if __name__ == "__main__":
    """for us run, python data_utils/data_converter.py --source=./cifar-10-pytho
n.tar.gz     --dest=datasets/cifar10-32x32.zip"""
    main()
